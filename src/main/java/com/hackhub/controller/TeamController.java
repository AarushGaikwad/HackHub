...
public class TeamController {
    ...
    public ResponseEntity<ResponseStatus<TeamResponseDto>> transferLeadership(@PathVariable Integer teamId, @RequestParam Integer currentLeaderId, @RequestParam Integer newLeaderId) {
