...
public class UserController {
    ...
    public ResponseEntity<ResponseStatus<ParticipantResponseDto>> registerParticipant(
            @RequestBody @Valid ParticipantRequestDto request) {
    ...
    public ResponseEntity<ResponseStatus<OrganizerResponseDto>> registerOrganizer(
            @RequestBody @Valid OrganizerRequestDto request) {
    ...
    // register judge
    @PostMapping("/judge")
        public ResponseEntity<ResponseStatus<JudgeResponseDto>> registerJudge(
    ...
    public ResponseEntity<ResponseStatus<List<UserResponseDto>>> getAllUsers() {
        ...
        return ResponseEntity
                ...
                .body(ResponseStatus.success(response)); //TODO: add this method in the admin controller
    }
}
